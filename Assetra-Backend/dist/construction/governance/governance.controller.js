...
const upsert_project_governance_dto_1 = require("./dto/upsert-project-governance.dto");
...
let GovernanceController = class GovernanceController {
    ...
    upsertByProject(projectId, dto, user) {
...
], GovernanceController.prototype, "findByProject", null);
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, upsert_project_governance_dto_1.UpsertProjectGovernanceDto, Object]),
    __metadata("design:returntype", void 0)
], GovernanceController.prototype, "upsertByProject", null);
