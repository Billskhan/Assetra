...
const attach_vendor_to_project_dto_1 = require("./dto/attach-vendor-to-project.dto");
...
let VendorsController = class VendorsController {
    ...
    findOne(user, vendorId) {
        return this.vendorsService.findOne(vendorId, user);
    }
    attachToProject(user, vendorId, projectId, _dto) {
...
__decorate([
    ...
    (0, roles_decorator_1.Roles)(client_1.Role.ADMIN, client_1.Role.PROJECT_MANAGER, client_1.Role.MANAGER, client_1.Role.STAKEHOLDER),
    __param(0, (0, current_user_decorator_1.CurrentUser)()),
    __param(1, (0, common_1.Param)('vendorId', common_1.ParseIntPipe)),
    __metadata("design:type", Function),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Number, Number, attach_vendor_to_project_dto_1.AttachVendorToProjectDto]),
    __metadata("design:returntype", void 0)
